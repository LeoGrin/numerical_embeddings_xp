...
if __name__ == "__main__":
    ...
    configs_dict = {
        ...
        #"dropout": [0.1],
        #"norm_first": [True],
        "gaussian_embedding_sd": [[base_sd], [base_sd / 3], [base_sd * 5], [base_sd * 10], [base_sd * 15]],
        "gaussian_embedding_left_bound": [-2.5],
        "gaussian_embedding_right_bound": [2.5],
        "gaussian_embedding_normalization": ["step"],
        "gaussian_embedding_embed_grid": ["equally_spaced"],
        "parametrize_std": [False],
        #"normalize_token_emb": [False, True],
        #"normalize_pos_enc": [False, True],
